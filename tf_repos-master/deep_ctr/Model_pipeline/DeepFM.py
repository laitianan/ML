...
tf.app.flags.DEFINE_string("dt_dir", '../../data/', "data dt partition")
tf.app.flags.DEFINE_string("model_dir", '../../data/', "model check point dir")
tf.app.flags.DEFINE_string("servable_model_dir", '../../data/', "export servable model for TensorFlow Serving")
...
def main(_):
    ...
    config = tf.estimator.RunConfig().replace(session_config = tf.ConfigProto(device_count={'GPU':2, 'CPU':FLAGS.num_threads}),
